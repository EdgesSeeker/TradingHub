...
const YearlyReview = ({ trades, onTradeUpdated }) => {
  const [yearlyData, setYearlyData] = useState(null);

  useEffect(() => {
    // TODO: Implement yearly review logic
    console.log('Yearly Review component loaded');
  }, []);
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{ margin: '0.5rem 0 0 0, color: '#94a3b8', fontSize: '0.875rem' }}>
              Annual trading performance analysis and insights
            </p>
          </div>
        </div>
      </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <h3 style={{
            ...
            Yearly Review Coming Soon
          </h3>
          <p style={{
            color: '#94a3b8',
            fontSize: '0.875rem'
          }}>
            This feature will provide comprehensive annual trading analysis
          </p>
        </div>
      </div>
    </div>
